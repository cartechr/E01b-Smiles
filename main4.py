...
for x in range(100,800,150):                                    #when i edit these, if affects all of the faces (makes faces go left or right, affects how many faces appear on screen, affects how close and how far apart the faces are.)
        ...
        for y in range(100,600,150):
                ...
                catch1_x,catch1_y = (face_x - 22, face_y + 30) 
                catch2_x,catch2_y = (face_x + 28, face_y + 30)  
